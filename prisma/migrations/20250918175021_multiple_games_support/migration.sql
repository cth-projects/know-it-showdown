...
DROP CONSTRAINT "Player_gameCode_fkey";

-- DropForeignKey
ALTER TABLE "public"."Question"
DROP CONSTRAINT "Question_category_fkey";

-- DropForeignKey
ALTER TABLE "public"."_GameToQuestion"
DROP CONSTRAINT "_GameToQuestion_A_fkey";

-- DropForeignKey
ALTER TABLE "public"."_GameToQuestion"
DROP CONSTRAINT "_GameToQuestion_B_fkey";
...
-- CreateIndex
CREATE UNIQUE INDEX "Game0To100Question_question_key"
ON "public"."Game0To100Question"("question");

-- CreateIndex
CREATE INDEX "_Game0To100ToGame0To100Question_B_index"
ON "public"."_Game0To100ToGame0To100Question"("B");

-- CreateIndex
CREATE UNIQUE INDEX "Game_upstashId_key"
ON "public"."Game"("upstashId");

-- CreateIndex
CREATE INDEX "Game_upstashId_idx"
ON "public"."Game"("upstashId");

-- AddForeignKey
ALTER TABLE "public"."Game0To100"
ADD CONSTRAINT "Game0To100_gameCode_fkey" FOREIGN KEY ("gameCode") REFERENCES "public"."Game"("gameCode")
ON DELETE CASCADE
ON
UPDATE
  CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Game0To100Player"
ADD CONSTRAINT "Game0To100Player_gameCode_fkey" FOREIGN KEY ("gameCode") REFERENCES "public"."Game0To100"("gameCode")
ON DELETE CASCADE
ON
UPDATE
  CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Game0To100Question"
ADD CONSTRAINT "Game0To100Question_category_fkey" FOREIGN KEY ("category") REFERENCES "public"."Game0To100Category"("name")
ON DELETE RESTRICT
ON
UPDATE
  CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."_Game0To100ToGame0To100Question"
ADD CONSTRAINT "_Game0To100ToGame0To100Question_A_fkey" FOREIGN KEY ("A") REFERENCES "public"."Game0To100"("gameCode")
ON DELETE CASCADE
ON
UPDATE
  CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."_Game0To100ToGame0To100Question"
ADD CONSTRAINT "_Game0To100ToGame0To100Question_B_fkey" FOREIGN KEY ("B") REFERENCES "public"."Game0To100Question"("id")
ON DELETE CASCADE
ON
UPDATE
  CASCADE;